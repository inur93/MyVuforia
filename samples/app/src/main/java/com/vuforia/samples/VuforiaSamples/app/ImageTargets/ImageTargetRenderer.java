...
import com.vuforia.samples.VuforiaSamples.app.UserDefinedTargets.Sprite;
...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private static final float OBJECT_SCALE_FLOAT = 0.009f; //0.003f
    ...
    public void setRed(float r){
        this.sprite.setRed(r);
    }
    public void setGreen(float g){
        this.sprite.setGreen(g);
    }
    public void setBlue(float b){
        this.sprite.setBlue(b);
    }
    public void setAlpha(float a){
        this.sprite.setAlpha(a);
    }

    public float[] getSpriteColor(){
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            int textureIndex = 0;
                    /*
                    trackable.getName().equalsIgnoreCase("crysis") ? 0
                    : 1;
