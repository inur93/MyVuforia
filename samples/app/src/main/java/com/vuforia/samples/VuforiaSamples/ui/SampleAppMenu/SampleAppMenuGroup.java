...
public class SampleAppMenuGroup
{
    ...
    public View addEditTextItem(String name, String text,final int command){
        Drawable selectorDrawable = mActivity.getResources().getDrawable(
                selectorResource);

        EditText newTextView = new EditText(mActivity);
        newTextView.setText(text);
        ...
        //newTextView.setClickable(true);
        //newTextView.setOnClickListener(mClickListener);
        newTextView.addTextChangedListener(new TextWatcher() {
            @Override
