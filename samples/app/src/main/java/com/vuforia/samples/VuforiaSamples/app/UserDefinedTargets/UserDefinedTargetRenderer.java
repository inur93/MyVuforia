...
public class UserDefinedTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private MyGL20Renderer myRenderer;
                                     ...
                                     SampleApplicationSession session)
    {
        ...
        myRenderer = new MyGL20Renderer(mActivity);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config)
    {
        ...
        myRenderer.onSurfaceCreated(gl, config);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height)
    {
        ...
        myRenderer.onSurfaceChanged(gl, width, height);
